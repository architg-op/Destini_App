...
struct StoryBrain {
    ...
    mutating func nextStory(userChoice : String, storyNumber : Int) -> Int {
        print("Check StoryNumber \(storyNumber)")
        self.storyNumber = storyNumber
        if userChoice == stories[storyNumber].choice1 {
            print("Returned if value \(stories[storyNumber].choice1Destination)")
